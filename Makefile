...
SHELL_FILES := box guest/hb guest/hb-workload guest/profile.sh guest/agent-bash-profile.sh provision/provision.sh tests/static.sh tests/lifecycle-smoke.sh tests/regressions.sh tests/fixtures/smolvm
